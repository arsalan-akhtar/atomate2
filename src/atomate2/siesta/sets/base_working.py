...
OUTPUT_FILE_NAME: str = "siesta.out"
CONTROL_FILE_NAME: str = "parameters.in"
GEOMETRY_FILE_NAME: str = "siesta.fdf"


DEFAULT_SIESTA_PROPERTIES = ("energy", "free_energy", "forces", "stress", "stresses", "dipole", "magmom")
...
class SiestaInputSet(InputSet):
    ...
    def __init__(
        ...
        siesta_control_in, aims_geometry_in = self.get_input_files()
        super().__init__(
            inputs={
...
class SiestaInputGenerator(InputGenerator):
    ...
    def get_input_set(
        ...
        return SiestaInputSet(parameters=parameters, structure=structure, properties=properties)
